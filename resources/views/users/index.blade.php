    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9 col-12">    
            <ul class="nav nav-tabs nav-justified mb-3">
                <li class="nav-item"><a href="{{ route("users.show", ["id" => $user->id]) }}" class="nav-link {{ Request::is("users/" . $user->id) ? "active" : "" }}">投稿 <span class="badge badge-secondary">{{ $count_posts }}</span></a></li>
